    ...
    <el-row>
      <el-col>
        ...
        <el-card class='box-card'>
          ...
          >
            <el-form-item label='款式：' prop='styles' class='search-item'>
            ...
            <el-table-column prop='status' label='状态'>
              <template slot-scope='scope'>
                <el-button
                  ...
                  size='mini'
                >{{scope.row.status=='0'?'未审核':scope.row.status=='1'?'已审核':'已完成'}}</el-button>
              </template>
            </el-table-column>
            <el-table-column prop='groups' label='组别'></el-table-column>
            <el-table-column prop='styles' label='款式'></el-table-column>
            <el-table-column prop='orders' label='订单'></el-table-column>
            <el-table-column prop='ordersNum' label='订单数'></el-table-column>
